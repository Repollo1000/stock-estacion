-- Bloque único: revierte el 0010 — "Sacar producto" vuelve a estar disponible para
-- cualquier miembro del negocio (no solo administradores). El historial de movimientos
-- (ya admin-only) sigue siendo el lugar para auditar quién sacó qué.
RESET ROLE;
